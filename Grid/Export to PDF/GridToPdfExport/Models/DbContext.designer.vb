...
Partial Public Class Customer
	...
	Private _Bool As System.Nullable(Of Boolean)
    ...
    End Sub
    Partial Private Sub OnBoolChanging(value As System.Nullable(Of Boolean))
    End Sub
    Partial Private Sub OnBoolChanged()
    End Sub
    #End Region
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_Bool", DbType:="Bit")>  _
	Public Property Bool() As System.Nullable(Of Boolean)
		Get
			Return Me._Bool
		End Get
		Set
			If (Me._Bool.Equals(value) = false) Then
				Me.OnBoolChanging(value)
				Me.SendPropertyChanging
				Me._Bool = value
				Me.SendPropertyChanged("Bool")
				Me.OnBoolChanged
			End If
		End Set
	End Property
